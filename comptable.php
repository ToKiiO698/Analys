      ...
      <div class="container" data-layout="container">
                  ...
                  <ul class="nav collapse show" id="dashboard">
                    <li class="nav-item">
                      ...
                      <ul class="nav collapse show navbar-vertical-content" id="dashboard">
                        <li class="nav-item">
                          <a class="nav-link" href="comptable/support.html">
                            <div class="d-flex align-items-center">
        ...
        <div class="content">
          ...
          >
            ...
            <a class="navbar-brand me-1 me-sm-3" href="comptable.html">
              <div class="d-flex align-items-center">
                <img
                  class="me-2"
            ...
            <div class="row g-0">
                <div class="col-lg-12 pe-lg-2 mb-6" style="margin-top: 10px;">
                    <div class="card h-lg-100 overflow-hidden panel-admin">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a href="dashboard/o-tickets.html" class="btn btn-primary panel-btn">Nouveau Ticket</a>
                            </div>
                            <div class="col-6">
                                <a href="dashboard/m-tickets.html" class="btn btn-primary panel-btn">Mes Tickets</a>
                            </div>
                        </div>
                    </div>
                </div>
