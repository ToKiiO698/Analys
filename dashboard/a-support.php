...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Gestion tickets - Analys</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
                  ...
                  <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                    <li class="nav-item">
                      ...
                      <ul class="nav collapse show" id="dashboard">
                        ...
                        <ul class="nav collapse show" id="dashboard">
                          <li class="nav-item">
                            <a class="nav-link active" href="../administration/h-facture.html">
                              <div class="d-flex align-items-center">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="a-support.html">
                            <div class="d-flex align-items-center">
        ...
        <div>
          <h1 class="text-center">Bienvenue dans le support</h1>
        </div>
                      ...
                      <div class="row align-items-center ">
                        <div class="col ">
                         ...
                         <div class="row">
                          ...
                          <div class="col-6">
                            <p>Corps du ticket :</p>
                            <a class="btn btn-primary facture-regle" href="">Réglé</a>
                          </div>

                          
                        </div> 
                        
                        <!-- rajouter chaque tickets dans cette card-->
