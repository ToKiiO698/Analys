                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="n-facture.php">
                        ...
                        <ul class="nav collapse show navbar-vertical-content" id="dashboard">
                          ...
                          <li class="nav-item">
                            <a class="nav-link active" href="ref-facture.php">
                              <div class="d-flex align-items-center">
...
<table id="factureTable" class="table table-striped table-hover">
  ...
  <tbody>
    ...
    // Requête pour récupérer toutes les données de la table facture
$stmt = $db->query('SELECT f.addr, f.tva, f.type_frais, f.id_facture, f.date_ajout, f.montant_ht, f.montant_ttc, f.justificatif, f.num_fac FROM facture f INNER JOIN etat_facture e ON f.etat_facture = e.id_etat WHERE f.etat_facture = 5');
