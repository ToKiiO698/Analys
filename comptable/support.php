        ...
        <div class="content">
          ...
          <div class="card mb-3">
            <div class="card-body px-xxl-0 pt-4">
              <div class="row g-0">
                  <div class="col-lg-12 pe-lg-2 mb-6" style="margin-top: 5px;">
                      <div class="card h-lg-100 overflow-hidden panel-admin">
                          <div class="card-header bg-body-tertiary">
                              <div class="row align-items-center">
                                  <div class="col">
                                      <h6 class="mb-0 text-center">Mes tickets - Commercial</h6>
                                  </div>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-6">
                                  <a href="o-tickets.html" class="btn btn-primary panel-btn">Nouveau Ticket</a>
                              </div>
                              <div class="col-6">
                                  <a href="m-tickets.html" class="btn btn-primary panel-btn">Mes Tickets</a>
                              </div>
                          </div>
                      </div>
                  </div>
