            ...
            <div class="card bg-100 shadow-none border">
              <div class="row gx-0 flex-between-center">
                <div class="col-sm-auto d-flex align-items-center"><img class="ms-n2"
                  ...
                  <div>
                    <h6 class="text-primary fs-10 mb-0">Bienvenue dans l'</h6>
                    <h4 class="text-primary fw-bold mb-0">Ajout <span class="text-info fw-medium">Utilisateur</span>
                    </h4>
              ...
              <div class="card h-lg-100 overflow-hidden facture-compta-comm">
                ...
                if (isset($_POST['id']) && isset($_POST['mdp']) && isset($_POST['role'])){
                  $id = $_POST['id'];
                  $mdp = $_POST['mdp'];
                  $role = $_POST['role'];
                  ...
                  <strong>OK.</strong> Utilisateur vient dêtre ajouté !
                  </div>';
                }}
                    ?>
                </form>
...
<!-- Mirrored from prium.github.io/nalys/v3.20.0/dashboard/project-management.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Mar 2024 23:08:02 GMT -->
</html>