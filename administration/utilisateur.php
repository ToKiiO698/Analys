...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Utilisateurs - Analys</title>
  ...
  <body>
      ...
      <div class="container" data-layout="container">
        ...
        >
          <div class="w-100">
                ...
                <li class="nav-item dropdown px-1">
                  <a
                    ...
                    >
                      ...
                      <circle cx="14" cy="2" r="2" fill="#6C6E71"></circle></svg>
                  </a>
                  <div
            ...
            <div
              class="collapse navbar-collapse scrollbar py-lg-2"
              id="navbarDoubleTop"
            >
              <ul
                class="navbar-nav"
                ...
                >
                  <div class="bg-white dark__bg-1000 rounded-3 py-2">
                    ...
                    ><a
                      ...
                      href="analytics.html"
                      >Analytics</a
                    ><a class="dropdown-item link-600 fw-medium" href="crm.html"
                      >CRM</a
                    ><a
                      class="dropdown-item link-600 fw-medium"
                      href="e-commerce.html"
        ...
        <div class="content">
          ...
          <h1 class="menu-admin">Bienvenue dans le menu Utilisateur !</h1>
          <div class="card mb-3">
              ...
              <div class="row g-0">
                ...
                >
                  ...
                  <h4 class="mb-1 font-sans-serif">
                    <span
                      ...
                      >0</span>  <!-- Mettre le nombre d'administrateur -->
                    <span class="fw-normal text-600">Nombre d'administrteur</span>
                  </h4>
                ...
                >
                  <div class="icon-circle icon-circle-info">
                    <span
                      class="fs-7 fas fa-chalkboard-teacher text-info"
                    ></span>
                  </div>
                  <h4 class="mb-1 font-sans-serif">
                    <span
                      class="text-700 mx-2"
                      data-countup='{"endValue":"324"}'
                      >0</span> <!-- Mettre le nombre de comptable -->
                    <span class="fw-normal text-600">Nombre de comptable</span>
                  </h4>
                ...
                >
                  ...
                  <h4 class="mb-1 font-sans-serif">
                    <span
                      class="text-700 mx-2"
                      data-countup='{"endValue":"3712"}'
                      >0</span>  <!-- Mettre le nombre de commercial -->
                    <span class="fw-normal text-600">Nombre de commercial</span>
                  </h4>
                  
                </div>
                <div
                  class="col-xxl-3 col-md-6 px-3 text-center pt-4 p-xxl-0 pb-0 pe-md-0"
                >
                  ...
                  <h4 class="mb-1 font-sans-serif">
                    ...
                    <span class="fw-normal text-600">Factures du moi dernier</span>
                  </h4>
          ...
          <div class="row g-0">
            <div class="col-lg-12 pe-lg-2 mb-6 ">
              <div class="card h-lg-100 overflow-hidden panel-admin">
                <div class="card-header bg-body-tertiary ">
                  <div class="row align-items-center ">
                    <div class="col ">
                      <h6 class="mb-0 ">Panel Administrateur</h6>
                    </div>
                  </div>
                </div>
                     <div class="row">
                ...
                <form>
                  ...
                  <div class="form-check">
                    ...
                    /><label
                      ...
                      <a class="white-space-nowrap" href="#!"
                        >privacy policy</a
                      ></label
                    >
                  </div>
    ...
    >
      <div class="offcanvas-header settings-panel-header bg-shape">
        <div class="z-1 py-1">
          <div class="d-flex justify-content-between align-items-center mb-1">
            ...
            <button
              class="btn btn-primary btn-sm rounded-pill mt-0 mb-0"
      ...
      <div
        class="offcanvas-body scrollbar-overlay px-x1 h-100"
        id="themeController"
      >
    ...
    >
      <div class="card-body d-flex align-items-center py-md-2 px-2 py-1">
        <div
          class="bg-primary-subtle position-relative rounded-start"
        ...
        <small
          class="text-uppercase text-primary fw-bold bg-primary-subtle py-2 pe-2 ps-1 rounded-end"
          >customize</small
        >
      </div>
    </a>
